...
def inbox(session):
    ...
    data = ses.get(f"https://play.google.com/store/apps/details?id=vn.mail.box={session}&_={str(__)}").json()
...
\x1b[1;96m| || |\ ||| | \||  \/|| / \|
\x1b[1;96m| || | \||| |_/||    /| |-||
\x1b[1;96m\_/\_/  \|\____/\_/\_\\_/ \|                           
\x1b[1;93m
\x1b[1;92m         INDRA PRATAP SINGH 
\x1b[1;91m-----------------------------------------------
\x1b[1;97m> Author : INDRA PRATAP SINGH 
\x1b[1;97m> Github : https://github.com/Indru740
\x1b[1;97m> Facebok: INDRA PRATAP SINGH 
\x1b[1;97m> Version: auto create facebook
\x1b[0;97m-----------------------------------------------"""
boy = ['rishabh singh chauhan', 'indra pratap singh', 'Faisal Khan', 'Afzal Khan', 'Adarsh singh', 'Suleman Khan', 'kartik singh', 'Nazeer Malik', 'sarad sukla', 'Nazeer Rehmani', 'Safdar Malik', 'Intzar Khan', 'Saleem Malik', 'Abdullah Malik', 'Naseer Jutt', 'Muzammil Malik', 'Fiaz Ahmad', 'Asghar Ali', 'Shabeer Ahmad', 'Irfan Ali', 'Ahmad Gujjar']
...
def menu():
    ...
    if sel in['1', '01']:
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=61551228050927?ref=share_link')
        menu()
    elif sel in ['3', '03']:
        os.system('xdg-open https://chat.whatsapp.com/+918429469176')
        menu()
    else:
    ...
    def start(self):
        ...
        for x in range(lim):
            ...
            try:
                ...
                create = ses.get(f"https://play.google.com/store/apps/details?id=vn.mail.box={buildses}&_={int(datetime.now().timestamp() * 1000)}").json()
